...
"""autogenerated by genpy from traffic_sign/AddTwoIntsRequest.msg. Do not edit."""
import sys
...
class AddTwoIntsRequest(genpy.Message):
  ...
  _type = "traffic_sign/AddTwoIntsRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from traffic_sign/AddTwoIntsResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class AddTwoIntsResponse(genpy.Message):
  _md5sum = "d41d8cd98f00b204e9800998ecf8427e"
  _type = "traffic_sign/AddTwoIntsResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """"""
  __slots__ = []
  _slot_types = []
