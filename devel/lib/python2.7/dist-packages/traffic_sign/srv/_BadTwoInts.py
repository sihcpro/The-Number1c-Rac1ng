...
"""autogenerated by genpy from traffic_sign/BadTwoIntsRequest.msg. Do not edit."""
import sys
...
class BadTwoIntsRequest(genpy.Message):
  ...
  _type = "traffic_sign/BadTwoIntsRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from traffic_sign/BadTwoIntsResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class BadTwoIntsResponse(genpy.Message):
  _md5sum = "d41d8cd98f00b204e9800998ecf8427e"
  _type = "traffic_sign/BadTwoIntsResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """"""
  __slots__ = []
  _slot_types = []
