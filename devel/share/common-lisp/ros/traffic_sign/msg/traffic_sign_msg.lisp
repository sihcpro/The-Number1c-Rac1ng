...
(cl:defmethod cl:initialize-instance :after ((m <traffic_sign_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'traffic_sign_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name traffic_sign-msg:<traffic_sign_msg> is deprecated: use traffic_sign-msg:traffic_sign_msg instead.")))

(cl:ensure-generic-function 'traffic_sign_type-val :lambda-list '(m))
(cl:defmethod traffic_sign_type-val ((m <traffic_sign_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader traffic_sign-msg:traffic_sign_type-val is deprecated.  Use traffic_sign-msg:traffic_sign_type instead.")
  (traffic_sign_type m))
